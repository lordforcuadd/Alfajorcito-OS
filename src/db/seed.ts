...
export function getSeedData(now = Date.now()) {
  ...
  const courses: Course[] = [
    // --- 2024-I (4to Ciclo - Histórico) ---
    {
      ...
      teacherEmail: 'cdelgado@ejemplo.local',
    ...
    },
    {
      ...
      teacherEmail: 'pmorales@ejemplo.local',
      createdAt: now - dayMs * 850,
      updatedAt: now - dayMs * 750,
      isArchived: true
    },
    ...
    // --- 2024-II (5to Ciclo - Histórico) ---
    {
      ...
      teacherEmail: 'cmerinos@ejemplo.local',
    ...
    },
    {
      ...
      teacherEmail: 'sdominguezl@ejemplo.local',
      createdAt: now - dayMs * 680,
      updatedAt: now - dayMs * 580,
      isArchived: true
    },
    ...
    // --- 2025-I (6to Ciclo - Histórico) ---
    {
      ...
      teacherEmail: 'mfernandeza@ejemplo.local',
    ...
    },
    {
      ...
      teacherEmail: 'mcalderond@ejemplo.local',
      createdAt: now - dayMs * 500,
      updatedAt: now - dayMs * 400,
      isArchived: true
    },
    ...
    // --- 2025-II (7mo Ciclo - Histórico) ---
    {
      ...
      teacherEmail: 'evaldiviam@ejemplo.local',
    ...
    },
    {
      ...
      teacherEmail: 'calarconq@ejemplo.local',
      createdAt: now - dayMs * 320,
      updatedAt: now - dayMs * 220,
      isArchived: true
    },
    ...
    },
    {
      ...
      teacherEmail: 'oorellanam@ejemplo.local',
    ...
    },
    {
      ...
      teacherEmail: 'pfloresr@ejemplo.local',
      createdAt: now - dayMs * 30,
      updatedAt: now - dayMs * 1,
      isArchived: false
    },
    ...
    // --- 2027-I (9no Ciclo - Próximo Semestre) ---
    {
      ...
      teacherEmail: 'internado_psicologia@ejemplo.local',
